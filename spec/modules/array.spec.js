...
describe('jfp array', function () {
    ...
    it('should set a baseline', function () {
        function isUndefined(value) {
            return typeof value === 'undefined';
        }

        function nthTest(index) {
    ...
    describe('nth', function () {
        ...
        it('should show me how many times a single signature recurses', function () {
            function add(a) {
                return function (b) {
                    return a + b;
                }
            }
            var test = signet.enforce('int => int => int', add);
